...
<div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
    ...
    <ul class="navbar-nav flex-row align-items-center ms-auto">
        <li class="nav-item lh-1 me-4">
            <a class="btn btn-sm btn-outline-primary" href="{{ route('home') }}">Lihat Toko</a>
        </li>
            ...
            <ul class="dropdown-menu dropdown-menu-end">
                ...
                <li>
                    <a class="dropdown-item" href="{{ route('admin.customers.index') }}">
                        <i class="icon-base bx bx-user icon-md me-3"></i><span>Pelanggan</span>
                    </a>
                </li>
                <li>
                    <a class="dropdown-item" href="{{ route('admin.products.index') }}">
                        <i class="icon-base bx bx-box icon-md me-3"></i><span>Produk</span>
                    </a>
                </li>
                <li>
                    <a class="dropdown-item" href="{{ route('admin.orders.index') }}">
                        <i class="icon-base bx bx-receipt icon-md me-3"></i><span>Pesanan</span>
                    </a>
                </li>
                <li>
                    <div class="dropdown-divider my-1"></div>
